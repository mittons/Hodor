...
namespace HodorCustomWinForms.TreeViewExplorerDisplay
{
    public partial class HodorTreeView : UserControl, ICurrentViewDataObserver
    {
        ...
        private void HodorTreeView_Load(object sender, EventArgs e)
        {
        ...
        private void AddProjectForestToTreeView(IProjectForest projectForest)
        {
            var projectForestRootNode = new TreeNode(projectForest.Title) { Tag = projectForest.Id };
            projectForestRootNode.NodeFont = new Font(this.treeView1.Font, FontStyle.Bold);
